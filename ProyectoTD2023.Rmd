...
###### fichero digital ######
  ...
  tiempo <- seq(0, length.out = nrow(datos_digitales), by = 1)
...
g <- ggplot(datos_analogicos10, aes(tiempo_analogico, datos_analogicos, col="blue")) +
  geom_line() +
  labs(
...
datos_digitales300 <- subset(datos_digitales, tiempo <= 1300)
