...
packages = c("knitr", "ggplot2","tidyr","dplyr","readr", "tidyverse")# use this function to check if each package is on the local machine
...
tiempo_digital <- as.data.frame(data[[1]][2])

datos_analogicos <- as.data.frame(data[[1]][3])
tiempo_analogico <- as.data.frame(data[[1]][4])

cabecera_D <- unlist(data[[2]][1])
cabecera_A1 <- unlist(data[[2]][2])
cabecera_A2 <- unlist(data[[2]][3])
```
